...
class GDetailsScreen extends StatefulWidget {
  GDetailsScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<GDetailsScreen> createState() => _GDetailsScreenState();
}

class _GDetailsScreenState extends State<GDetailsScreen> {
